...
public class LoginController {
	...
	public String userLogin(Model model, @ModelAttribute("userForm") User user, RedirectAttributes attributes,
		...
		if (null != loggedUser) {
			...
			attributes.addFlashAttribute("error", "Does Not Match.Try Again !!!");
			return "redirect:/";
		}
	...
	public String userRegistration(Model model, @ModelAttribute("customerForm") @Validated CustomerDto customerDto,BindingResult bindingResult,
	RedirectAttributes attributes) throws ResourceNotFoundException    {
	...
	try {	
		...
		if (null != c) {
			attributes.addFlashAttribute("success", "Customer Registered Successfully");
